...
class BayesianSamplerValuePrior(_BanditAgent):
    ...
    def choose_action(self):
        prior_mean = np.mean(self._mean_reward)
        prior_var = np.var(self._mean_reward)
...
class BayesianSamplerBroadPrior(_BanditAgent):
    def __init__(self, num_actions=10, rng=None):
        self._step = 0
        self._prior_mean = 0
